...
Check-FileContains ".saurus\installer\Configure-SaurusRemote.ps1" "SAURUS_REMOTE_HEADLESS_POSTINSTALL_V5" "Configurador headless"
...
Check-FileContains ".saurus\installer\Configure-SaurusRemote.ps1" "SAURUS_REMOTE_VERIFY_INTERACTIVE_SERVER_V1" "Servidor interativo validado"
Check-FileContains ".saurus\installer\Configure-SaurusRemote.ps1" '$ServiceAccount = "LocalSystem"' "Servico usa LocalSystem"
