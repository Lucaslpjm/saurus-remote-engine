...
Check-FileContains "flutter\lib\common.dart" 'static const Color accent = Color(0xFFE3CF66);' "Cor de destaque Saurus"
Check-FileContains "flutter\lib\common.dart" 'Color(0xFF202030)' "Fundo Saurus"
