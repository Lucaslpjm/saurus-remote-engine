...
def validate(repo_root: Path) -> None:
    ...
    require(ui_apply, "SAURUS_ANDROID_INCOMING_ACCEPT_V2", "incoming accept action patch")
    require(ui_apply, "def patch_incoming_accept_dialog_content", "incoming accept helper")
    require(ui_verify, "child: Text('Aceitar')", "visible incoming accept verification")
