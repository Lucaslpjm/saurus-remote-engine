...
def verify(root: Path, kit_root: Path) -> None:
    ...
    for relative in [
        ...
        "mipmap-mdpi/saurus_launcher_foreground.png",
        "mipmap-hdpi/saurus_launcher_foreground.png",
        "mipmap-xhdpi/saurus_launcher_foreground.png",
        "mipmap-xxhdpi/saurus_launcher_foreground.png",
        "mipmap-xxxhdpi/saurus_launcher_foreground.png",
